...
const Header = () => {
    ...
    return (
        <>
            {isAwPage || isLandingPage || isEmailNoVerified || isSendEmailPassword || isUserActionPage || isLoginPage || isBuilderPage ? null : <div className="bg-black h-[5rem] flex justify-end items-center">
