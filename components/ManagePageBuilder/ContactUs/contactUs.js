        ...
        try {
            ...
            await getDoc(databaseWebPageRef).then((doc) => {
                ...
                switch (socialMediaSelected) {
                    ...
                    case "google":
                        updateDoc(databaseWebPageRef, {
                            totalGoogleRedirects: parseInt(webpageData?.totalGoogleRedirects) + 1,
                        })
                        window.open(pageDesign?.google, "_blank");
                        break;
                    default:
                        break;
                }
    ...
    return (
        <div className={`flex flex-col`} style={divStyles}>
            ...
            <div className={`flex flex-col mdx1000:!flex-row`}>
                ...
                {/* social media */}
                {pageDesign?.showSocialMedia && (pageDesign?.fb || pageDesign?.twitter || pageDesign?.linkedIn || pageDesign?.google) &&
                    <div className={`gap-y-6 grid pb-20 grid-cols-2 mdx1000:mt-10 mdx1000:ml-10 mdx1000:grid-cols-1`}>
                        ...
                        {pageDesign?.google && <div className='flex flex-col items-center space-y-1 h-min cursor-pointer' onClick={() => redirectToSocialMedia("google")}>
