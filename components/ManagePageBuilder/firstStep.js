    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-white">
            <div className="relative rounded-lg p-5 mx-auto z-50 border-[.2rem]">
                ...
                <p className="text-black font-bold text-[1.4rem] text-center">{t("first-step.desc")}</p>
                <div className="flex flex-col items-center mt-5">
                    <div>
                        <p className="text-center font-semibold">{t("first-step.page-name")}</p>
                    ...
                    <div>
                        ...
                        <p className="text-center font-semibold">{t("first-step.logo")}</p>
                    </div>
                </div>
                <div className="flex">
