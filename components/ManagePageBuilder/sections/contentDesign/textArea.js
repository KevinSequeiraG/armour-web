    ...
    return (
        <div>
            <div className='relative'>
                <textarea name="text" value={contentValues?.text} onChange={handleInputChange} className='w-full rounded-[10px] shadow border py-0.5 pl-2 pr-7 border-[#224553]' />
            ...
            <div className='flex items-center space-x-1 justify-between mt-3'>
                ...
                <div className='flex justify-center items-center space-x-1'>
                    ...
                    <input min={0} name="marginRight" value={contentValues?.marginRight} onChange={handleInputChange} type='number' className='w-1/2 bg-white border border-[#224553] rounded-[5px] px-2 hide-spin-buttons text-center' data-tooltip-id="nav-content-text-pl" data-tooltip-content={t("page-builder.tool-page-padding-left")} />
                ...
                <div className='flex justify-center items-center space-x-1'>
                    ...
                    <input min={0} name="marginTop" value={contentValues?.marginTop} onChange={handleInputChange} type='number' className='w-1/2 bg-white border border-[#224553] rounded-[5px] px-2 hide-spin-buttons text-center' data-tooltip-id="nav-content-text-pb" data-tooltip-content={t("page-builder.tool-page-padding-bottom")} />
                    <em className='font-normal text-xs'>%</em>
