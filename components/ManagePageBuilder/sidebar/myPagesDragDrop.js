...
const MypagesDragDrop = (props) => {
  ...
  const handleAddPage = async () => {
    ...
    const newPage = { id: pages?.length + 1, name: sectionNameSelected, paddingLeft: "20%", paddingRight: "20%", paddingTop: "5%", paddingBottom: "15%", backgroundColor: "#ffffff", isContactPage: false, sections: [] };
  ...
  const handleAddContactForm = async () => {
    ...
    const newPage = { id: pages?.length + 1, name: formValues.name, paddingLeft: "20%", paddingRight: "20%", paddingTop: "5%", paddingBottom: "15%", backgroundColor: "#ffffff", isContactPage: true, showSocialMedia: true, fb: "", twitter: "", linkedIn: "", google: "", emailRecieve: formValues.email, inputTextColor: "#5e5e5e", buttonTextColor: "#f5f5f5", inputColor: "#f5f5f5", textColor: "#000000", buttonColor: "#00CC88", language: "es", sections: [], bgImage: "" };
