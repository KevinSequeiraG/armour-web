...
const MypagesDragDrop = (props) => {
  ...
  const handleAddPage = async () => {
    ...
    const newPage = { id: pages?.length + 1, name: sectionNameSelected, paddingLeft: "15%", paddingRight: "15%", paddingTop: "5%", paddingBottom: "10%", backgroundColor: "#ffffff", isContactPage: false, sections: [] };
  ...
  const handleAddContactForm = async () => {
    ...
    const newPage = { id: pages?.length + 1, name: formValues.name, paddingLeft: "15%", paddingRight: "15%", paddingTop: "5%", paddingBottom: "10%", backgroundColor: "#ffffff", isContactPage: true, showSocialMedia: true, fb: "", twitter: "", linkedIn: "", instagram: "", emailRecieve: formValues.email, inputTextColor: "#5e5e5e", buttonTextColor: "#f5f5f5", inputColor: "#f5f5f5", textColor: "#000000", buttonColor: "#00CC88", sections: [], bgImage: "" };
