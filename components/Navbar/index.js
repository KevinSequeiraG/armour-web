        ...
        <aside className="bg-[#212429] w-[18rem] h-full px-4 flex justify-between flex-col">
            <div>
                ...
                <div className="relative">
                    <button onClick={() => setShowReportsOptions(!showReportsOptions)} className="items-center text-[#EFE1A2] hover:bg-gray-900 border border-1 border-[#C69434] rounded-[.5rem] text-left px-4 font-semibold py-3 w-full bg-[#212429] flex"><img src="/svgs/Report.svg" className="mr-2 w-[1.5rem]" />Reportes</button>
