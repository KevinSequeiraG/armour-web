    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-60">
            <div className="relative bg-white rounded-lg p-5 py-[3rem] mx-auto z-50 border border-[.2rem] border-gray-500">
                <div className="flex">{products.map((prod) => {
                    return (
                        <>
                            <ProductCard data={{ isCategory: false }} sectionInfo={prod} />
                ...
                <p className="text-[1.5rem] text-center font-semibold mb-10">Seguro que quiere eliminar la categoria "{props.categoryName}"?</p>
                <div className="flex">
