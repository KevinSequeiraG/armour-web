...
const ContactUs = () => {
    ...
    return (
        <div className="bg-main h-[92vh] px-20 pt-10 pb-20 overflow-y-auto scrollbar flex flex-col">
            <Head>
            ...
            <div className="w-4/5 mx-auto !bg-gray-600 rounded-[10px] p-8 shadow-md text-white grid grid-cols-2 gap-4">
                ...
                <div className='relative'>
                    ...
                    <input className={`w-full rounded-[10px] bg-[#f5f5f5] text-black font-medium shadow mt-1 px-3 py-2`} type="number" placeholder={t("user-data.phone")} name="phone" value={formValues.phone} onChange={handleInputChange} />
                </div>
